...
public class BlockUtil {
    public static boolean inRange(BlockPos pos, Player player) {
        return inRange(pos, player, Services.PLATFORM_HELPER.getReachDistance(player));
    }
    ...
    public static BlockHitResult getLineOfSight(BlockPos pos, Player player) {
        return getLineOfSight(pos, player, Services.PLATFORM_HELPER.getReachDistance(player));
    }
